    ...
    <section id="locations" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-light text-neutral-800 mb-4">Our Location</h2>
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Visit our flagship salon in Wigram.
          </p>
        </div>

        <div className="max-w-xl mx-auto">
          <div
            className="bg-neutral-50 rounded-lg overflow-hidden shadow-lg transition-all duration-500"
